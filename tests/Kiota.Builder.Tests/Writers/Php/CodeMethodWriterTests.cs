    ...
    public class CodeMethodWriterTests: IDisposable
    {
        ...
        public void WriteRequestExecutor()
        {
            CodeProperty[] properties =
            {
                ...
                new CodeProperty { Kind = CodePropertyKind.RequestAdapter, Name = "urlTemplate" },
                new CodeProperty { Kind = CodePropertyKind.RequestAdapter, Name = "pathParameters" },
            };
        ...
        public static IEnumerable<object[]> DeserializerProperties => new List<object[]>
        {
            ...
            new object[]
            {
                ...
                "'height' => function (ParseNode $n) use ($currentObject) { $currentObject->setHeight($n->getStringValue()); },"
            },
            new object[]
            {
            ...
            new object[]
            {
                ...
                "'story' => function (ParseNode $n) use ($currentObject) { $currentObject->setStory($n->getBinaryContent()); },"
            },
